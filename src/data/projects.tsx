...
const projects: Project[] = [
  ...
  { // 01. AI Docker file optimizer project
    id: "aichatbot",
    category: "AI and Development",
    title: "AI Chatbot",
    src: "/assets/projects-screenshots/aichatbot/1.png",
    screenshots: ["1.png"],
    live: "https://github.com/supertalent18/ResearchGPT",
    github:"https://github.com/supertalent18/ResearchGPT",
    skills: {
    ...
    get content() {
      return (
        <div>
          <TypographyP className="font-mono ">
            An AI assistant to help you with with your research. It uses the OpenAI API to generate a response to your question. It also allows you to upload a file and ask a question about the file.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <SlideShow
            images={[
              `${BASE_PATH}/aichatbot/1.png`,
            ]}
          />
        </div>
      );
  ...
  { // 02. FinanceMe project
    ...
    title: "Invoify",
    src: "/assets/projects-screenshots/invoify/1.png",
    screenshots: ["/assets/projects-screenshots/invoify/1.png"],
    skills: {
      frontend: [
        PROJECT_SKILLS.html,
        PROJECT_SKILLS.css,
    ...
    live: "https://invoify.vercel.app/",
    github: "https://github.com/supertalent18/invoify",
    get content() {
      return (
        <div>
          <TypographyP className="font-mono text-2xl text-center">
            Invoify: Web-based Invoice Generator
          </TypographyP>
          <TypographyP className="font-mono ">
          ...
          <ProjectsLinks live={this.live} repo={this.github} />
          <TypographyH3 className="my-4 mt-8">Core Technologies </TypographyH3>
          <p className="font-mono mb-4">
            <ul className="list-disc ml-6">
              <li className="font-mono">Next.js: React framework for SSR and client-side navigation.</li>
              <li className="font-mono">TypeScript: JavaScript superset with static typing.</li>
              <li className="font-mono">Shadcn-UI: UI library for enhanced visuals.</li>
              <li className="font-mono">Tailwind: Utility-first CSS framework.</li>
              <li className="font-mono">React Hook Form: Form management for React.</li>
              <li className="font-mono">Zod: TypeScript-first schema validation.</li>
              <li className="font-mono">Puppeteer: PDF generation with headless browsers.</li>
            </ul>
          </p>
          <SlideShow
            images={[
              `${BASE_PATH}/invoify/1.png`,
            ]}
          />
        </div>
      );
  ...
  { // 04. Smart parking assitant
    ...
    src: "/assets/projects-screenshots/stablediffusion/1.png",
    screenshots: ["/assets/projects-screenshots/stablediffusion/1.png"],
    live: "https://github.com/supertalent18/ChatGPT_DALL_E_StableDiffusion_Telegram_Bot",
    github:"https://github.com/supertalent18/ChatGPT_DALL_E_StableDiffusion_Telegram_Bot",
    skills: {
    ...
    get content() {
      return (
        <div>
          ...
          <SlideShow
            images={[
              `${BASE_PATH}/stablediffusion/1.png`,
            ]}
          />
        </div>
      );
  ...
  { // 05. Smart Job Tracker project
    ...
    github:"https://github.com/supertalent18/Job-tracker-application",
    skills: {
      frontend: [PROJECT_SKILLS.js, PROJECT_SKILLS.next, PROJECT_SKILLS.tailwind, PROJECT_SKILLS.vite],
  ...
  { // 06. Savinder Puri portfolio project
    id: "tsnexttailwindstarter",
    category: "Web Development",
    title: "TypeScript, Next.js, Tailwind Portfolio",
    src: "/assets/projects-screenshots/tsnexttailwindstarter/01.png",
    screenshots: ["/assets/projects-screenshots/tsnexttailwindstarter/01.png"],
    live: "https://tsnext-tw.thcl.dev/components/",
    github:"https://github.com/supertalent18/ts-nextjs-tailwind-starter",
    skills: {
      frontend: [PROJECT_SKILLS.js, PROJECT_SKILLS.next, PROJECT_SKILLS.tailwind, PROJECT_SKILLS.vite],
      backend: [],
    },
    get content() {
      return (
        <div>
          ...
          <SlideShow
            images={[
              `${BASE_PATH}/tsnexttailwindstarter/01.png`,
            ]}
          />
        </div>
      );
